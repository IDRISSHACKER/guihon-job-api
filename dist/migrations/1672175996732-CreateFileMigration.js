...
exports.CreateFileMigration1672175996732 = void 0;
class CreateFileMigration1672175996732 {
    constructor() {
        this.name = 'CreateFileMigration1672175996732';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "planing" ("id" varchar PRIMARY KEY NOT NULL, "clientId" integer NOT NULL, "rewindDay" integer NOT NULL, "prix" integer NOT NULL, "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "REL_97d06fe2e120af7b36e3861a36" UNIQUE ("clientId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_planing" ("id" varchar PRIMARY KEY NOT NULL, "clientId" integer NOT NULL, "rewindDay" integer NOT NULL, "prix" integer NOT NULL, "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "REL_97d06fe2e120af7b36e3861a36" UNIQUE ("clientId"), CONSTRAINT "FK_97d06fe2e120af7b36e3861a368" FOREIGN KEY ("clientId") REFERENCES "client" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_planing"("id", "clientId", "rewindDay", "prix", "updated_at", "created_at") SELECT "id", "clientId", "rewindDay", "prix", "updated_at", "created_at" FROM "planing"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "planing" ("id" varchar PRIMARY KEY NOT NULL, "clientId" integer NOT NULL, "rewindDay" integer NOT NULL, "prix" integer NOT NULL, "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "REL_97d06fe2e120af7b36e3861a36" UNIQUE ("clientId"))`);
        await queryRunner.query(`INSERT INTO "planing"("id", "clientId", "rewindDay", "prix", "updated_at", "created_at") SELECT "id", "clientId", "rewindDay", "prix", "updated_at", "created_at" FROM "temporary_planing"`);
...
exports.CreateFileMigration1672175996732 = CreateFileMigration1672175996732;
//# sourceMappingURL=1672175996732-CreateFileMigration.js.map