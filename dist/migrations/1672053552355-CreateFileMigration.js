...
exports.CreateFileMigration1672053552355 = void 0;
class CreateFileMigration1672053552355 {
    constructor() {
        this.name = 'CreateFileMigration1672053552355';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_presence" ("id" varchar PRIMARY KEY NOT NULL, "userId" integer NOT NULL, "ended" boolean NOT NULL DEFAULT (0), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_6c0fa00ffa14c9eaf62cc32a600" FOREIGN KEY ("userId") REFERENCES "employe" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
...
exports.CreateFileMigration1672053552355 = CreateFileMigration1672053552355;
//# sourceMappingURL=1672053552355-CreateFileMigration.js.map